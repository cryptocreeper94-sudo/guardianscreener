  ...
  async getTransactionHistory(): Promise<any[]> {
    ...
    for (const swap of recentSwaps) {
      transactions.push({
        id: swap.id,
        type: "swap",
        token: `${swap.tokenIn} ‚Ü‚Äô ${swap.tokenOut}`,
...
const SEED_ZONES: InsertCityZone[] = [
  ...
  // Wild West Era
  { era: "wildwest", name: "Main Street", description: "The dusty heart of town ‚Ä‚Äù saloon, general store, and the marshal's office", zoneType: "commercial", gridX: 0, gridY: 0, width: 4, height: 4, totalPlots: 16, occupiedPlots: 0, architectureStyle: "wildwest" },
