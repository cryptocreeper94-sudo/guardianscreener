...
const CHAINS: { id: Chain; name: string; icon: string; color: string; native: string }[] = [
  { id: 'solana', name: 'Solana', icon: 'ââ€”Ž', color: 'from-purple-500 to-cyan-500', native: 'SOL' },
  { id: 'ethereum', name: 'Ethereum', icon: 'Îž', color: 'from-blue-500 to-purple-500', native: 'ETH' },
  { id: 'base', name: 'Base', icon: 'ðŸâ€µ', color: 'from-blue-400 to-blue-600', native: 'ETH' },
  { id: 'polygon', name: 'Polygon', icon: 'â¬¡', color: 'from-purple-400 to-purple-600', native: 'MATIC' },
  { id: 'bsc', name: 'BNB Chain', icon: 'ðŸâ€¶', color: 'from-yellow-400 to-yellow-600', native: 'BNB' },
  { id: 'arbitrum', name: 'Arbitrum', icon: 'ðŸâ€·', color: 'from-blue-500 to-cyan-500', native: 'ETH' },
  { id: 'optimism', name: 'Optimism', icon: 'ðŸâ€´', color: 'from-red-400 to-red-600', native: 'ETH' },
  { id: 'avalanche', name: 'Avalanche', icon: 'ðŸâ€º', color: 'from-red-500 to-red-600', native: 'AVAX' },
];
